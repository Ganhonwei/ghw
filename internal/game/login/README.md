...
cd $GOPATH/bin
./qtc -file ../src/goserver/login/templates/download.qtpl
./qtc -file ../src/goserver/login/templates/jtpayorder.qtpl
./qtc -file ../src/goserver/login/templates/jtpayreturn.qtpl

cd $GOPATH/src/goserver/bin
