...
func Test(t *testing.T) {
	...
	payurl := cfg.Section("").Key("templatepay.payurl").String()
	withdrawurl := cfg.Section("").Key("templatepay.withdrawurl").String()
	merchant := cfg.Section("").Key("templatepay.merchant").String()
	appid := cfg.Section("").Key("templatepay.appid").String()
	serverPubRSA := cfg.Section("").Key("templatepay.serverPubRSA").String()
	clientPriRSA := cfg.Section("").Key("templatepay.clientPriRSA").String()
	md5key := cfg.Section("").Key("templatepay.md5key").String()
