...
func Test(t *testing.T) {
	...
	payurl := cfg.Section("").Key("bjsteocpay.payurl").String()
	withdrawurl := cfg.Section("").Key("bjsteocpay.withdrawurl").String()
	merchant := cfg.Section("").Key("bjsteocpay.merchant").String()
	appid := cfg.Section("").Key("bjsteocpay.appid").String()
	serverPubRSA := cfg.Section("").Key("bjsteocpay.serverPubRSA").String()
	clientPriRSA := cfg.Section("").Key("bjsteocpay.clientPriRSA").String()
	md5key := cfg.Section("").Key("bjsteocpay.md5key").String()
