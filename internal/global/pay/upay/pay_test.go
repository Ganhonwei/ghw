...
func Test(t *testing.T) {
	...
	InitConfig(payurl, withdrawurl, merchant, appid, "", "", md5key, payNotifyUrl, withdrawNotifyUrl)
	...
	order.Amount = 20000
	order.OrderID = id
	order.IFSC = "TEST0000430"
	order.BankNumber = "919892514285"
	order.RealName = "test"
	order.Mobile = "919852146882"
	order.Email = "test@mail.com"
	order.Userid = "1234567890"
