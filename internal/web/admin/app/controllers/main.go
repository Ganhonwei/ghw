...
func (this *MainController) SetPageSize() {
	// 从请求中获取用户选择的页面大小
	selectedPageSize, _ := this.GetInt("page")
	this.SetSession("page_size", selectedPageSize)
	// beego.AppConfig.Set("page_size", selectedPageSize)
	// this.display()
}
